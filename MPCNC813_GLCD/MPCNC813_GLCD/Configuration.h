...
#define CUSTOM_MACHINE_NAME "Filips CNC" //MPCNC
 ...
 */
#define TEMP_SENSOR_0 998 //MPCNC
...
#define DUMMY_THERMISTOR_999_VALUE 170 //MPCNC
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // MK8 MPCNC
  #define  DEFAULT_Kp 17.98 //MPCNC
  #define  DEFAULT_Ki .98   //MPCNC
  #define  DEFAULT_Kd 83.62 //MPCNC
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 375, 200 } //MPCNC
...
#define INVERT_X_DIR true //MPCNC
#define INVERT_Y_DIR true
#define INVERT_Z_DIR true //MPCNC
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 196 //MPCNC
#define PREHEAT_1_TEMP_BED     62 //MPCNC
...
//
#define ENCODER_PULSES_PER_STEP 4 //MPCNC JEFFEB3

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //MPCNC JEFFEB3
...
//
#define REVERSE_ENCODER_DIRECTION //MPCNC
