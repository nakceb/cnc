  ...
  switch (command_code) {
    ...
    case 'M': switch (codenum) {
        ...
        case 1: // M1: Conditional stop - Wait for user button press on LCD
          ...
          break;
      #endif // ULTIPANEL
      case 3://spindle on Filip
        //SET_OUTPUT(RAMPS_D8_PIN);
        stepper.synchronize(); 
        digitalWrite(RAMPS_D8_PIN,HIGH);
        //digitalWrite(RAMPS_D9_PIN,HIGH);
        //digitalWrite(RAMPS_D10_PIN,HIGH);
        SERIAL_PROTOCOLLNPGM("Spindle Turned On");
        break;

      case 5: //spindle off Filip
        stepper.synchronize(); 
        digitalWrite(RAMPS_D8_PIN,LOW);
        SERIAL_PROTOCOLLNPGM("Spindle Turned Off");
        break;
